...
inline.gfm = merge({}, inline.normal, {
  ...
  url: /^(https?:\/\/[^\s<]+[^<.,:;"')\]\s])/,
  youtubeid: /(?:(?:youtube.com\/watch\?v=)|(?:youtu.be\/))([A-Za-z0-9\_\-]+)/i,
  del: /^~~(?=\S)([\s\S]*?\S)~~/,
...
Renderer.prototype.link = function(href, title, text) {
  ...
  if (href.match(imgs)){
    if (href.indexOf('http://dirtyimg.com/')>-1){
      ...
      out = href.replace(imgs, '<img src="https://img1.steemit.com/0x0/$1" class="postimg" onerror="this.src=\'scripts/img/noimage.png\'" />');  
    } else {
      out = href.replace(imgs, '<img src="$1" class="postimg" onerror="this.src=\'scripts/img/noimage.png\'" />');  
    }
  } else {
    if (href.match(youtube)) {
      var YouTube1 = mediaParseIdFromUrl('youtube', href);
      out = href.replace(youtube, '<iframe width="100%" height="480" src="http://www.youtube.com/embed/' + YouTube1 + '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe>');
...
Renderer.prototype.image = function(href, title, text) {
  ...
  out += this.options.xhtml ? ' onerror="this.src=\'scripts/img/noimage.png\'"/>' : ' onerror="this.src=\'scripts/img/noimage.png\'">';//this.parentNode.removeChild(this);
  return out;
};
