...
.run(['taRegisterTool', '$window', 'taTranslations', 'taSelection', 'taToolFunctions', '$sanitize', 'taOptions', '$log', '$rootScope',
    function(taRegisterTool, $window, taTranslations, taSelection, taToolFunctions, $sanitize, taOptions, $log, $rootScope){
    ...
    taRegisterTool('insertImage', {
        ...
        action: function(){
            ...
            $rootScope.$on('receiveImage', function(){
